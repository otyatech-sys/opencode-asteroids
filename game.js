...
// ── Estado del juego ──────────────────────────────────────────────────────────
let ship, bullets, asteroids, particles, speedBoosts, shootingStars, tripleShots;
...
function drawHUD() {
  ...
  if (ship.tripleShotTimer > 0 && !ship.dead) {
    ...
    const x = W / 2 - barWidth / 2;
    const y = 34;
    const fill = (ship.tripleShotTimer / TRIPLE_DURATION) * barWidth;
